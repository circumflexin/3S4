...
bf3 = animatedline('MaximumNumPoints',100,Color="magenta", LineWidth = 2); 
...
if ~isfile(score_file)
    writetable(array2table(zeros(0,8),'VariableNames',{'Vessel_no','Vessel_name','W_vessel_start','W_vessel_end','Decision_point','Final_loop_start' 'Final_loop_end', 'Notes'}),score_file)
end
